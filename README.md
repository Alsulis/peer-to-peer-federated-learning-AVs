...
The core of the IDS is built upon a novel deep learning model, Soft Reordering one-dimensional Convolutional Neural Network (SR-1CNN), designed to efficiently handle independent and non-independent distributed data scenarios.

## Usage of AdmmSGD Algorithm

This project also incorporates the **AdmmSGD** algorithm as part of the peer-to-peer federated learning process, which is adapted from the study:
...
- **Conference**: Proceedings of the 26th ACM SIGKDD International Conference on Knowledge Discovery & Data Mining (KDD 2020), pages 668-678
- **Link**: [ACM Digital Library](https://dl.acm.org/doi/pdf/10.1145/3394486.3403109)

The code implementing **AdmmSGD** can be found in the folder named **`edgecons`**, and the specific script is `admm_sgd.py`.
